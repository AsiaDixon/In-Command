...
<section class="mb-8">
  ...
  <h3>Sample Code</h3>
  <pre><code class="html"><?php echo htmlspecialchars(file_get_contents('components/buttons/c-type.php'), ENT_QUOTES); ?></code></pre>
</section>
...
<?php include 'partials/end.php';?><?php include 'partials/start.php';?>
      <h1 class="text-5xl text-teal font-sans">Typography </h1>
